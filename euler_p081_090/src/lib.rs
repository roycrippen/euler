...
pub fn p084() -> String {
    ...
    enum Bd { GO = 0, A1, CC1, A2, T1, R1, B1, CH1, B2, B3, JAIL, C1, U1, C2, C3, R2, D1, CC2, D2,
    ...
    let mut game: &mut Vec<Sim> = &mut vec![Sim { name: Bd::GO, visits: 0 },
                                            Sim { name: Bd::A1, visits: 0 },
                                            Sim { name: Bd::CC1, visits: 0 },
                                            Sim { name: Bd::A2, visits: 0 },
                                            Sim { name: Bd::T1, visits: 0 },
                                            Sim { name: Bd::R1, visits: 0 },
                                            Sim { name: Bd::B1, visits: 0 },
                                            Sim { name: Bd::CH1, visits: 0 },
                                            Sim { name: Bd::B2, visits: 0 },
                                            Sim { name: Bd::B3, visits: 0 },
                                            Sim { name: Bd::JAIL, visits: 0 },
                                            Sim { name: Bd::C1, visits: 0 },
                                            Sim { name: Bd::U1, visits: 0 },
                                            Sim { name: Bd::C2, visits: 0 },
                                            Sim { name: Bd::C3, visits: 0 },
                                            Sim { name: Bd::R2, visits: 0 },
                                            Sim { name: Bd::D1, visits: 0 },
                                            Sim { name: Bd::CC2, visits: 0 },
                                            Sim { name: Bd::D2, visits: 0 },
                                            Sim { name: Bd::D3, visits: 0 },
                                            Sim { name: Bd::FP, visits: 0 },
                                            Sim { name: Bd::E1, visits: 0 },
                                            Sim { name: Bd::CH2, visits: 0 },
                                            Sim { name: Bd::E2, visits: 0 },
                                            Sim { name: Bd::E3, visits: 0 },
                                            Sim { name: Bd::R3, visits: 0 },
                                            Sim { name: Bd::F1, visits: 0 },
                                            Sim { name: Bd::F2, visits: 0 },
                                            Sim { name: Bd::U2, visits: 0 },
                                            Sim { name: Bd::F3, visits: 0 },
                                            Sim { name: Bd::G2J, visits: 0 },
                                            Sim { name: Bd::G1, visits: 0 },
                                            Sim { name: Bd::G2, visits: 0 },
                                            Sim { name: Bd::CC3, visits: 0 },
                                            Sim { name: Bd::G3, visits: 0 },
                                            Sim { name: Bd::R4, visits: 0 },
                                            Sim { name: Bd::CH3, visits: 0 },
                                            Sim { name: Bd::H1, visits: 0 },
                                            Sim { name: Bd::T2, visits: 0 },
                                            Sim { name: Bd::H2, visits: 0 }];
    ...
    fn chance(mut pos: Pos, game: &mut Vec<Sim>) -> Pos {
        let chance = vec![Bd::GO, Bd::JAIL, Bd::C1, Bd::E3, Bd::H2, Bd::R1];
        ...
        if pos.chance_pos < 6 {
            ...
            if chance[pos.chance_pos] == Bd::JAIL {
                pos.double_cnt = 0;
            }
        } else {
            match pos.chance_pos {
                6 | 7 => {
                    match game[pos.pos].name {
                        Bd::CH1 => pos.pos = Bd::R2 as usize,
                        Bd::CH2 => pos.pos = Bd::R3 as usize,
                        Bd::CH3 => pos.pos = Bd::R1 as usize,
                        _ => pos.pos = pos.pos,
                    }
                }
                8 => {
                    match game[pos.pos].name {
                        Bd::CH1 | Bd::CH3 => pos.pos = Bd::U1 as usize,
                        Bd::CH2 => pos.pos = Bd::U2 as usize,
                        _ => pos.pos = pos.pos,
                    }
                }
                9 => pos.pos -= 3,
    ...
    fn do_move(mut pos: Pos, game: &mut Vec<Sim>) -> Pos {
        ...
        if d1 == d2 {
            if pos.double_cnt == 2 {
                pos.double_cnt = 0;
                pos.pos = Bd::JAIL as usize;
                game[Bd::JAIL as usize].visits += 1;
                return pos;
            } else {
                pos.double_cnt += 1
            }
        ...
        match game[pos.pos].name {
            Bd::CH1 | Bd::CH2 | Bd::CH3 => pos = chance(pos, game),
            Bd::CC1 | Bd::CC2 | Bd::CC3 => pos = cc(pos),
            Bd::G2J => {
                pos.double_cnt = 0;
                pos.pos = Bd::JAIL as usize;
            }
...
pub fn get_functions() -> (u32, Vec<fn() -> String>) {
    ...
    (81, vec![p081, p082, p083, p084, p085, p086, p087, p088, p089, p090])
}
